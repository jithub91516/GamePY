...
# check collision 
    ...
    #calculate the time 
    elapsed_time = (pygame.time.get_ticks() - start_ticks) / 1000 # devide ticks by 1000 cuz it is millisecond

    timer = game_font.render(str(int(total_time - elapsed_time)), True, (255,255,255)) # words that u wanna print, True, font color
...
pygame.time.delay(2000) #wait for 2 second to quit
